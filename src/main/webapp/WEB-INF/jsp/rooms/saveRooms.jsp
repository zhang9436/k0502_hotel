...
<div style="display: none;margin-top: 20px;" id="saveRoomsDiv">
    ...
    <div class="layui-upload" align="center" style="margin-bottom: 20px;">
        <div class="layui-upload-list">
            <img class="layui-upload-img" id="demo1" src="/img/fm1.jpg" width="50px" height="50px">
            <p id="demoText"></p>
        </div>
    ...
    <form class="layui-form layui-form-pane" action="" style="margin-left: 50px;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="roomNum" name="roomNum" placeholder="请输入房间号" lay-verify="required|roomNum|checkRoomNum" autocomplete="off" class="layui-input"
