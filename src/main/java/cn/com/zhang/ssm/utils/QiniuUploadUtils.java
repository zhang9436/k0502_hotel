package cn.com.zhang.ssm.utils;
...
public class QiniuUploadUtils {
    ...
    static String ACCESS_KEY = "C-Un14apHF9SirNCeFhDUIxf95qiP4L1MrMWJlhs";
    static String SECRET_KEY = "EynehSAYmMTXyVuNnz0CZoOKogLwhhHdp_aTaPRt";
    //要上传的空间;对应到七牛上（自己建文件夹 注意设置公开）  //http://qgbu6ffn6.hn-bkt.clouddn.com
    static String bucketname = "zz9436";
    //上传到七牛后保存的文件名  
